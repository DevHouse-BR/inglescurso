...
if ($template->isIe(6)) {
	...
	'
	<style type="text/css">
	img, div { behavior: url(' . $template->url . '/iepngfix.htc) }
	</style>
	';*/
	
	
	//$ie6[] = sprintf($js, $template->url.'/iepngfix_tilebg.js');
	
	//$ie6[] = sprintf($js, $template->url.'/pngfix.js');
	
	//$ie6[] = sprintf($js, $template->url.'/supersleight-min.js');
